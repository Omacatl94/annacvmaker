...
const it = {
  ...
  landing: {
    logo: 'JobHacker',
    badge: 'Prova gratis \u2014 zero account, zero carta',
    h1_line1: 'Il sistema non e\' dalla tua parte.',
    h1_accent: 'Noi si\'.',
    subtitle: '100 candidature personalizzate in ore, non mesi. Ogni CV ottimizzato per passare i filtri automatici \u2014 in 5 minuti, con AI.',
    tryFree: 'Inizia gratis',
    tryHint: 'Zero registrazione. Risultati in 5 minuti.',
    wait: 'Un momento...',
    loginLink: 'Accedi',
    ...
    step1Text: 'Copia la job description dal sito dell\'azienda. L\'AI estrae le keyword che l\'ATS cerchera\' nel tuo CV.',
    step2Title: 'L\'AI genera il tuo CV',
    ...
    feat3Text: 'Non ti piace una frase? Cliccaci sopra e riscrivila. Il CV e\' tuo, l\'AI ti da\' la base.',
    ...
    pricingSubtitle: '2 CV al giorno, zero costi. Nessuna carta di credito. Provalo ora.',

    ctaTitle: 'Il mercato del lavoro e\' truccato. Gioca meglio.',
    ...
    ctaBtn: 'Inizia gratis \u2014 zero registrazione',
  ...
  generator: {
    ...
    jdPlaceholder: 'Incolla qui la job description. Piu\' e\' dettagliata, meglio lavora l\'AI.',
    jdRequired: 'Serve l\'annuncio. Incolla la job description qui sopra.',
    langLabel: 'Lingua del CV',
    styleLabel: 'Stile',
    generate: 'Genera CV',
    modeJd: 'Ho una Job Description',
    modeSpontaneous: 'Candidatura Spontanea',
    urlLabel: 'Sito web dell\'azienda',
    urlPlaceholder: 'https://www.azienda.it',
    roleLabel: 'Ruolo desiderato',
    rolePlaceholder: 'es. Frontend Developer, Data Analyst...',
    urlRequired: 'Inserisci l\'URL del sito aziendale.',
    roleRequired: 'Inserisci il ruolo desiderato.',
    scrapingProgress: 'Analizzo il sito...',
    sparseTitle: 'Informazioni limitate',
    sparseMessage: 'Ho trovato poche informazioni su questa azienda. Il CV sara\' piu\' generico — vuoi procedere comunque?',
    sparseConfirm: 'Procedi',
    sparseCancel: 'Annulla',
  ...
  form: {
    ...
    onboardHint: 'L\'AI analizza il tuo profilo rispetto all\'annuncio e ti suggerisce cosa sistemare prima di generare.',
  ...
  upload: {
    ...
    subtext: 'L\'AI legge il tuo CV e pre-compila tutti i campi',
  ...
  pricing: {
    ...
    remaining: 'crediti rimasti',
    lowCredits: 'Hai pochi crediti rimasti.',
    noCredits: 'Crediti esauriti. Ricarica per continuare.',
    paymentSuccess: 'Pagamento completato! I crediti sono stati aggiunti.',
  ...
  beta: {
    ...
    landingText: '2 CV / giorno + invita amici per di piu\'.',
  },
